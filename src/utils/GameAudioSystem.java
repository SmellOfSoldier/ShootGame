...
public class GameAudioSystem {
    ...
    public  class playShotAudio extends Thread{
        ...
        public playShotAudio(AudioInputStream audioInputStream){
        }
        public void run(){
    ...
    //播放函数
    public void stratAudio(String gunname,byte[] gunaudio) {
        //new playShotAudio().start();
    }
    //关闭音频流通道
...
class test{
    public static void main(String[] args) {
        ...
        test.stratAudio("AKM",test.ReadAudio.getAKMAUDIO());
}}

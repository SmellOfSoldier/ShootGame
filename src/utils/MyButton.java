...
public class MyButton extends JButton {
    ...
    private JTextArea contentArea;//控制关联的文字框
     ...
     * 关联控件式构造
     * @param buttonText 按钮内文字
     * @param showmes 关联文字控件显示的文字
     * @param contentArea 关联的文字空间
     */
    public MyButton(String buttonText,String showmes, JTextArea contentArea) {
        super(buttonText);
